...
public class StringUtils extends org.apache.commons.lang.StringUtils{
    ...
    public static String getUUID() {
        return null;// UUID.randomUUID().toString().replaceAll("-", "").toUpperCase().substring(0, 10);
    }
    
    public static String getUUID(final int len) {
        return null;//UUID.randomUUID().toString().replaceAll("-", "").toUpperCase().substring(0, len);
    }
