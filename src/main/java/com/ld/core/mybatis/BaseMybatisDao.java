...
import com.ld.core.mybatis.page.MysqlDialect;
...
public class BaseMybatisDao<T> extends SqlSessionDaoSupport {
	...
	private PreparedStatement getPreparedStatement4Count(String sql,
	  ...
	  public Pagination findPageBySql(final Map<String, Object> params, final Integer pageNo, final Integer pageSize) {
	        return this.findPage(params.get("selectSql").toString(), params.get("countSql").toString(), params, pageNo, pageSize);
	    }
